...
namespace CurvedPathGenerator
{
    ...
    internal class PathFollowerGUI : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(15f);
            Undo.RecordObject(pathFollower, "Modify " + pathFollower.gameObject.name);
            pathFollower.Speed = EditorGUILayout.Slider(pathFollower.Speed, -200, 600f);
            GUILayout.EndHorizontal();
            GUILayout.Space(5f);
            ...
            GUILayout.Space(15);
            Undo.RecordObject(pathFollower, "Modify " + pathFollower.gameObject.name);
            pathFollower.positionOffset = EditorGUILayout.Vector3Field("Offset", pathFollower.positionOffset);
            GUILayout.EndHorizontal();
